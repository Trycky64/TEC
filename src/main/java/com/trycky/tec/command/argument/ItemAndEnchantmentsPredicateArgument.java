/*
 * Based on ItemAndEnchantmentsPredicateArgument from ClientCommands
 * by Earthcomputer and contributors (LGPL-3.0-or-later).
 * Adapted for NeoForge 1.21.1 / TEC.
 */
package com.trycky.tec.command.argument;
...
public class ItemAndEnchantmentsPredicateArgument implements ArgumentType<ItemAndEnchantmentsPredicateArgument.ItemAndEnchantmentsPredicate> {
    ...
    private static final DynamicCommandExceptionType ID_INVALID_EXCEPTION = new DynamicCommandExceptionType(id ->
        Component.translatable("argument.item.id.invalid", String.valueOf(id))
    );
